#include "const_point_factor.h"

namespace basic 
{
Eigen::Matrix2d ConstPointFactor::const_sqrt_info;

ConstPointFactor::ConstPointFactor(const Vector3d& _pt_c):
    pt_c(_pt_c)
{}

bool ConstPointFactor::Evaluate(const double*const* parameters, double* residuals, double** jacobians) const
{
    ...
    residual = const_sqrt_info * residual;	
